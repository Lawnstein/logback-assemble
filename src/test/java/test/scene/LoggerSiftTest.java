 ...
 * @version $Revision:$
 */
public class LoggerSiftTest {
	private final static Logger logger = LoggerFactory.getLogger(LoggerSiftTest.class);

	private final static String config = LoggerSiftTest.class
			.getResource("/test/scene/logback-" + LoggerSiftTest.class.getSimpleName() + ".xml").getFile();
