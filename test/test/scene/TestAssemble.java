...
import test.ccbs.tran.BaseAction;
import test.ccbs.tran.T15001Action;
import test.ccbs.tran.T15002Action;
import test.ccbs.tran.T15003Action;
...
public class TestAssemble {
	...
	private final static String config = TestAssemble.class
			.getResource("/test/ccbs/logback-" + TestAssemble.class.getSimpleName() + ".xml").getFile();
